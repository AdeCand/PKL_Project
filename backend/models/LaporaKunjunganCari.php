...
/**
 * LaporaKunjunganCari represents the model behind the search form of `backend\models\LaporanKunjungan`.
 */
class LaporaKunjunganCari extends LaporanKunjungan
{
    /**
     * {@inheritdoc}
     */
